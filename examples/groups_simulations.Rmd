...
extract_estimates_from_simulation_results <- function(res){
  ...
  est_df <- apply(mean_cov_matrices, 3, function(cov_mat){
    vec <- c(cov_mat[1,1], cov_mat[2,2], cov_mat[1,2])
    names(vec) <- c(paste0("var_", coef_names),
                    paste0(c("covar" ,coef_names), collapse="_"))
    vec
...
knitr::kable(
  tidyr::pivot_wider(results_1, c("cluster","parameter"), 
                   names_from = c("method","distribution"))
  )
```
...
knitr::kable(
  tidyr::pivot_wider(results_2, c("cluster","parameter"), 
                 names_from = c("method","distribution"))
)
```
...
knitr::kable(
  tidyr::pivot_wider(results_3, c("cluster","parameter"), 
                   names_from = c("method","distribution"))
)
```
...
knitr::kable(
  tidyr::pivot_wider(results_4, c("cluster","parameter"), 
                   names_from = c("method","distribution"))
)
```
...
knitr::kable(
  tidyr::pivot_wider(results_5, c("cluster","parameter"), 
                   names_from = c("method","distribution"))
)
```