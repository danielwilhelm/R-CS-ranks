...
This confidence of including in the resulting set every population that should be there is called **controlling the type I error** in statistics. The standard value of this confidence is 95%. One can get smaller sets, if wishes to sacrifice some confidence in return.
...
Based only on the estimates of mean test scores, we would assign the UK 13th position in the ranking. However, due to uncertainty of results, its *true* position could be as high as 8 and as low as 23. 
...
plot(CS_simul, popnames=pisa$jurisdiction, title="Ranking of OECD Countries by 2018 PISA Math Score", 
